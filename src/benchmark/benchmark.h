...
class Benchmark {
 public:
  Benchmark(std::shared_ptr<dingodb::sdk::ClientStub> client_stub, std::shared_ptr<sdk::Client> client);
  ~Benchmark() = default;

  static std::shared_ptr<Benchmark> New(std::shared_ptr<dingodb::sdk::ClientStub> client_stub,
                                        std::shared_ptr<sdk::Client> client);
...
class Environment {
 public:
  ...
  std::shared_ptr<dingodb::sdk::ClientStub> GetClientStub() { return client_stub_; }
