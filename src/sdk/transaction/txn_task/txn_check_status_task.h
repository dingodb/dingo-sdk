...
#ifndef TXN_CHECK_STATUS_TASK_H
#define TXN_CHECK_STATUS_TASK_H
...
class TxnCheckStatusTask : public TxnTask {
 ...
 private:
  ...
  std::string Name() const override { return "TxnCheckStatusTask"; }

  void TxnCheckStatusRpcCallback(const Status& status);
