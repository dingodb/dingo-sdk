...
#ifndef TXN_HEARTBEAT_TASK_H
#define TXN_HEARTBEAT_TASK_H
...
class TxnHeartbeatTask : public TxnTask {
 ...
 private:
  ...
  std::string Name() const override { return "TxnHeartbeatTask"; }
