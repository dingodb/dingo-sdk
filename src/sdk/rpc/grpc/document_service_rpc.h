...
#ifndef DINGODB_SDK_GRPC_DOCUMENT_SERVICE_RPC_H_
#define DINGODB_SDK_GRPC_DOCUMENT_SERVICE_RPC_H_
...
DECLARE_DOCUMENT_SERVICE_RPC(DocumentSearchAll);
...
#endif  // DINGODB_SDK_GRPC_DOCUMENT_SERVICE_RPC_H_