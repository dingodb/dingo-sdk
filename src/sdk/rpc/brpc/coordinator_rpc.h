...
DECLARE_COORDINATOR_RPC(CreateRegionId);
DECLARE_COORDINATOR_RPC(GetRegionMap);
DECLARE_COORDINATOR_RPC(GetStoreMap);
DECLARE_COORDINATOR_RPC(TransferLeaderRegion);

// MDS
DECLARE_COORDINATOR_RPC(MDSHeartbeat);
DECLARE_COORDINATOR_RPC(GetMDSList);

DECLARE_META_RPC(CreateAutoIncrement);
DECLARE_META_RPC(DeleteAutoIncrement);
DECLARE_META_RPC(GenerateAutoIncrement);
DECLARE_META_RPC(UpdateAutoIncrement);
DECLARE_META_RPC(GetAutoIncrement);
DECLARE_META_RPC(GetAutoIncrements);
