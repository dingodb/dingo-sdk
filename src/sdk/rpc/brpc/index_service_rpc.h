...
DECLARE_INDEX_SERVICE_RPC(VectorImport);
DECLARE_INDEX_SERVICE_RPC(VectorBuild);
DECLARE_INDEX_SERVICE_RPC(VectorLoad);
DECLARE_INDEX_SERVICE_RPC(VectorStatus);
DECLARE_INDEX_SERVICE_RPC(VectorReset);
