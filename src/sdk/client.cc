...
StoreState PBStoreStateToStoreState(pb::common::StoreState pb_store_state) {
...
StoreInState PBStoreInStateToStoreInState(pb::common::StoreInState pb_store_in_state) {
