...
DEFINE_int32(thread_count, 100, "thread count");
DEFINE_int32(txn_test_frequency_1PC, 500000, "txn 1PC test frequency");
DEFINE_int32(txn_test_frequency_2PC, 100000, "txn 2PC test frequency");
